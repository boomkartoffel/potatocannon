 ...
 *
 * This setting can be applied to individual [Potato] or globally to the [Cannon].
 *
 ...
 * @since 0.1.0
 */
class Expectation(val description: String, private val check: Check) : PotatoSetting,
    CannonSetting {
 ...
 * @since 0.1.0
 */
fun interface Check : PotatoSetting, CannonSetting {
